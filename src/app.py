"""실행: python -m streamlit run src/app.py --server.address 127.0.0.1 --server.port 8502"""
...
# src 패키지를 찾을 수 있도록 저장소 루트를 명시적으로 등록합니다.
...
from src.query import plan_query, resolve_document_scope
from src.repository import Repository
from src.settings import GuideError, load_settings
...
if page == 'manage' and admin:
    from src.admin_ui import render_admin
    try:
