"""로컬 검색 평가: python -m src.evaluate --cases docs/search-cases.example.jsonl
...
from src.library import Chunk, Embedder, LocalLibrary, bounded_embedding_question, clean, protect_private
from src.query import plan_query
from src.settings import DIMENSIONS, MODEL, GuideError, load_settings
